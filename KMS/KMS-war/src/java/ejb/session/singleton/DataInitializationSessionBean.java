...
public class DataInitializationSessionBean {
 ...
 //       materialResourceAvailableSessionBean.createMaterialResourceAvailable(new MaterialResourceAvailableEntity("name", 100, "description", new Date(), new Date(), "country", new ArrayList<TagEntity>()), 1);
        ...
        try {
            ...
            projectSessionBean.createNewProject(new ProjectEntity("Educating Farmers", "Edcuate market gardeners and farmers on protecting land, soil degradation and more efficient agricultural techniques.", new Date(), "Viet Nam", "", 1000.0), 4l, new ArrayList<Long>(Arrays.asList(24l, 34l)));
