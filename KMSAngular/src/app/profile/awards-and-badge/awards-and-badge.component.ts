...
@Component({
  selector: 'app-awards-and-badge',
  templateUrl: './awards-and-badge.component.html',
  styleUrls: ['./awards-and-badge.component.css']
})
export class AwardsAndBadgeComponent implements OnInit {
